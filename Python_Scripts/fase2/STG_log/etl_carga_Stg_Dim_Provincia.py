...
def main():
    ...
    try: 
        ...
        if conn:
            ...
            # Trunca la tabla Stg_Dim_Almacen
            tabla = 'Stg_Dim_Provincia'
            ...
            with open(csv_file_path, mode= 'r', encoding= 'utf-8') as file:
                ...
                for line in csv_reader:
                    cursor.execute('''
                        INSERT INTO Stg_Dim_Provincia (CodigoProvincia, Provincia, Latitud, Longitud)
                        VALUES (?, ?, ?, ?)
                                ''', line)
