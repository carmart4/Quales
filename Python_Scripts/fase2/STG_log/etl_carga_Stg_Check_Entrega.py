...
def main():
    ...
    try: 
        ...
        if conn:
            ...
            # Trunca la tabla Stg_Check_Entrega
            tabla = 'Stg_Check_Entrega'
            ...
            with open(csv_file_path, mode= 'r', encoding= 'utf-8') as file:
                ...
                for line in csv_reader:
                    cursor.execute('''
                        INSERT INTO Stg_Check_Entrega (CodigoEntrega, CodigoVenta, CodigoProveedor, Proveedor,
                                CodigoAlmacen, Almacen, CodigoEstado, Estado, FechaEnvio, FechaEntregaEstimada)
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                                ''', line)
