...
def main():
    ...
    try: 
        ...
        if conn:
            ...
            #Traer los años de la fecha de envio.
            cursor.execute('''SELECT DISTINCT YEAR(FechaEnvio)
            ...
            #Traer los años de la fecha de entrega estimada. Para el caso en que la compra se registre 31/12 o 01/01
            cursor.execute('''SELECT DISTINCT YEAR(FechaEntregaEstimada)
                            FROM Int_Check_Entrega''')
